    ...
    <div class="container py-14">
      <div class="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div class="lg:col-span-1">
          <a href="${base}index.html" class="footer-logo inline-block mb-4">
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            ...
            <li><a href="${base}conditions/index.html">Conditions Treated</a></li>
            <li><a href="${base}about/index.html">About Dr. Hiebert</a></li>
            <li><a href="${base}new-patient-special/index.html">$99 New Patient Special</a></li>
            <li><a href="${base}appointment/index.html">Book Appointment</a></li>
            <li><a href="${base}contact/index.html">Contact & Hours</a></li>
          </ul>
        </div>
        <div>
        ...
        <div>
          ...
          <a href="${base}appointment/index.html" class="btn btn-primary btn-sm mt-5">Request Appointment</a>
        </div>
      </div>
      <div class="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between text-xs text-white/50">
        ...
        <div class="flex gap-4">
          <a href="${base}privacy-policy/index.html">Privacy Policy</a>
          <a href="${base}terms-of-service/index.html">Terms of Service</a>
        </div>
      </div>
    </div>
  </footer>`;
